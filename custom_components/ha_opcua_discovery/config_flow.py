...
from homeassistant.const import CONF_NAME, CONF_URL, CONF_SCAN_INTERVAL, CONF_USERNAME, CONF_PASSWORD
        ...
        if user_input is not None:
            ...
            return self.async_create_entry(
                ...
                data={
                    ...
                    CONF_HUB_SCAN_INTERVAL: user_input.get(CONF_SCAN_INTERVAL, DEFAULT_SCAN_INTERVAL),
